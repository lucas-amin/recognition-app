...
class BaseModule(object):
    ...
    def fit(self, train_data, eval_data=None, eval_metric='acc',
        ...
        >>> sym, arg_params, aux_params = mx.classifier_model.load_checkpoint(model_prefix, 3)
    ...
    def set_params(self, arg_params, aux_params, allow_missing=False, force_init=True,
        ...
        >>> sym, arg_params, aux_params = mx.classifier_model.load_checkpoint(model_prefix, n_epoch_load)
